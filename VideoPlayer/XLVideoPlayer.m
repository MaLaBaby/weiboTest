...
- (void)smallWindowPlay {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        CGRect smallFrame = CGRectMake(tableViewframe.origin.x + tableViewframe.size.width - w, tableViewframe.origin.y + tableViewframe.size.height - h - TABBAR_HEIGHT, w, h);
